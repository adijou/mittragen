  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        answer: "Suche, Logo-Status, Sponsorstatus und bestätigtes Paket lassen sich kombinieren. Die Filter gelten auch für die Paketübersicht.",
        steps: ["Suchen Sie unter «Sponsoren» nach Firma, Kontakt, Ort oder Paket. Wählen Sie bei Bedarf ein Paket oder «Ohne bestätigtes Paket».", "Klicken Sie auf eine Spaltenüberschrift zum aufsteigenden Sortieren, nochmals zum absteigenden Sortieren. In der Paketübersicht lässt sich auch nach Paketbeträgen und Total sortieren. «Zurücksetzen» setzt Suche, Filter und Sortierung zurück.", "Öffnen Sie zum Ändern des Status «Bearbeiten», wählen Sie den gewünschten Status und speichern Sie die Änderung."],
    ...
    articles: [
      {
        ...
        steps: ["Suchen Sie nach Sponsor, Vertragsnummer oder Paket und grenzen Sie die Liste über «Status» und «Paket» ein. Klicken Sie auf eine Spaltenüberschrift zum Sortieren; ein weiterer Klick kehrt die Reihenfolge um.", "Wählen Sie beim gewünschten Vertrag «Details öffnen». Dokumente, Bearbeitung und Nachweise erscheinen in einer eigenen Ansicht.", "Mit «Zurück zur Übersicht» gelangen Sie zur Tabelle zurück. Suche, Paket- und Statusfilter sowie Sortierung bleiben erhalten.", "Aufgehobene Vertragsstände finden Sie über den Statusfilter «Archivierte Verträge»."],
      },
      {
        ...
        steps: ["Bereiten Sie eine CSV- oder Excel-Datei mit einer Zuordnung pro Zeile vor: Sponsor, Paket, Jahreswert CHF, Abschlussdatum, Unterzeichnende Person, Nachweis.", "Verwenden Sie eindeutige bestehende Sponsor- und Paketnamen sowie Abschlussdaten im Format JJJJ-MM-TT. Fehlende Daten oder unterzeichnende Personen bleiben leer und werden als unbekannt dokumentiert.", "Prüfen Sie die Vorschau, die Jahreswerte und die Nachweise. Sie können die Spalten sortieren und nach Text, Paket oder Prüfungsstatus filtern; übernommen werden weiterhin alle geprüften Zeilen der Datei. Interne Paketentwürfe können für Altbestand verwendet werden.", "Bestätigen Sie die geprüften Angaben und wählen Sie «Geprüfte Altverträge übernehmen». Identische vorhandene Zuordnungen werden übersprungen. Bei einem abweichenden bestehenden Vertrag stoppt die Übernahme zur Prüfung."],
